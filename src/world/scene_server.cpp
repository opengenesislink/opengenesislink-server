    ...
    try {
        ...
        socket.send_frame({protocol::MessageType::hello_ack, hello.request_id,
                           protocol::payload_from_string(
                               ...
                               "object_runtime=linkset-v2,motion-v1,text-v1,physics-v3,primitive-shapes-v1,raycast-v1,spring-constraint-v1,character-capsule-v1,collision-events-v1,interaction-v1\n")});
