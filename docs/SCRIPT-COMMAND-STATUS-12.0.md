# OpenGenesisLINK 12.0 — Script Command Status

Diese Datei wird aus den in 12.0 gepflegten ScriptEngine-Katalogen abgeleitet. Sie ist die Wiki-Referenz für den Implementierungsstand der nativen OGL-Skriptsprache und der LSL-Kompatibilität.

## Statusdefinition

| Status | Bedeutung |
|---|---|
| ✅ `implemented` | Im 12.0-Vertrag ausführbar und für den dokumentierten Umfang implementiert. |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| OGL | 37 | 37 | 0 | 0 | 0 | 100.00% | 100.00% | 100.00% |
| LSL Funktionen | 523 | 56 | 29 | 413 | 25 | 10.71% | 16.25% | 100.00% |
...
12.0 behält den in 11.0 abgeschlossenen OGL-v2-Kernvertrag (31/31) bei und erweitert den aktuellen Katalog um sechs native Physics-v2-Befehle. Der 12.0-Katalog umfasst damit 37/37 implementierte Merkmale.
