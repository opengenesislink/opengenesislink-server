...
public:
    AssetStore(std::string metadata_path, std::filesystem::path blob_directory,
               std::size_t max_asset_bytes = 1024U * 1024U);

    [[nodiscard]] std::optional<AssetInfo> create(std::string owner_user_id, std::string name,
